...
static int mt9m114_s_max_virt_dgain(struct v4l2_subdev* sd, s32 val) {
  ...
  ret = mt9m114_write16(client, VAR_CAM_AET_AE_MAX_VIRT_DGAIN, val);
  if(!ret) ret = mt9m114_wait_for_vertical_blanking(client);
  if(!ret) ret = mt9m114_refresh(client);
  return ret;
}
...
static int mt9m114_g_ctrl(struct v4l2_subdev* sd, struct v4l2_control* ctrl) {
  ...
  switch(ctrl->id) {
    ...
    case V4L2_MT9M114_AE_MIN_VIRT_DGAIN:
      return mt9m114_g_min_virt_dgain(sd, &ctrl->value);
    case V4L2_MT9M114_AE_MAX_VIRT_DGAIN:
      return mt9m114_g_max_virt_dgain(sd, &ctrl->value);
    case V4L2_MT9M114_AE_MIN_VIRT_AGAIN:
      return mt9m114_g_min_virt_again(sd, &ctrl->value);
    case V4L2_MT9M114_AE_MAX_VIRT_AGAIN:
      return mt9m114_g_max_virt_again(sd, &ctrl->value);
    case V4L2_MT9M114_AE_WEIGHT_TABLE_0_0:
    case V4L2_MT9M114_AE_WEIGHT_TABLE_0_1:
    case V4L2_MT9M114_AE_WEIGHT_TABLE_0_2:
    case V4L2_MT9M114_AE_WEIGHT_TABLE_0_3:
...
static int mt9m114_s_ctrl(struct v4l2_subdev* sd, struct v4l2_control* ctrl) {
  ...
  switch(ctrl->id) {
    ...
    case V4L2_MT9M114_AE_MIN_VIRT_DGAIN:
      return mt9m114_s_min_virt_dgain(sd, ctrl->value);
    case V4L2_MT9M114_AE_MAX_VIRT_DGAIN:
      return mt9m114_s_max_virt_dgain(sd, ctrl->value);
    case V4L2_MT9M114_AE_MIN_VIRT_AGAIN:
      return mt9m114_s_min_virt_again(sd, ctrl->value);
    case V4L2_MT9M114_AE_MAX_VIRT_AGAIN:
      return mt9m114_s_max_virt_again(sd, ctrl->value);
    case V4L2_MT9M114_AE_WEIGHT_TABLE_0_0:
    case V4L2_MT9M114_AE_WEIGHT_TABLE_0_1:
    case V4L2_MT9M114_AE_WEIGHT_TABLE_0_2:
    case V4L2_MT9M114_AE_WEIGHT_TABLE_0_3:
